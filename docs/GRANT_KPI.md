...
The primary KPI is the **number of unique Solana transaction-safety scenarios that pass the complete TxSpec validation process**.
...
2. Its metadata passes the strict TxSpec fixture schema.
...
- References to TxSpec fixtures in another project's tests or documentation
